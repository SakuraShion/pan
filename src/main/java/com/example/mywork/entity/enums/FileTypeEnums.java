...
public enum FileTypeEnums {
    ...
    private FileCategoryEnums fileCategoryEnums;
    ...
    FileTypeEnums(FileCategoryEnums fileCategoryEnums,Integer type, String[] suffix, String desc) {
        this.fileCategoryEnums = fileCategoryEnums;
        this.type = type;
        this.suffix = suffix;
        this.desc = desc;
    }
    ...
    public static FileTypeEnums getFileTypeBySuffix(String suffix) {
        for (FileTypeEnums fileTypeEnums : FileTypeEnums.values()) {
            if (ArrayUtils.contains(fileTypeEnums.suffix, suffix)) {
